...
#                     if (arrow_point["movement_row_direction"] == 0) & (arrow_point["movement_column_direction"] == 0):
#                         continue
#                     ax.arrow(arrow_point["geometry"].x, arrow_point["geometry"].y,
#                              arrow_point["movement_column_direction"] / arrow_point["movement_distance_pixels"] * arrow_spacing_pixels,
#                              -arrow_point["movement_row_direction"]  / arrow_point["movement_distance_pixels"] * arrow_spacing_pixels,
